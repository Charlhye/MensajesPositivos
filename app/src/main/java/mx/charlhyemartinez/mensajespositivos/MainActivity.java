package mx.charlhyemartinez.mensajespositivos;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView frase = (TextView) findViewById(R.id.frase);
        final ImageView fondo = (ImageView) findViewById(R.id.fondo);
        final Switch noche = (Switch) findViewById(R.id.dia);

        fondo.setBackgroundColor(Color.rgb(0,128,128));

        final ArrayList <String> frases = new ArrayList<>();
        Collections.addAll(frases, new String[]{"Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
        ...
        frase.setText(frases.get(new Random().nextInt(frases.size()-1)));

        Button back = (Button) findViewById(R.id.back);
        Button fwd = (Button) findViewById(R.id.fwd);
        Button go = (Button) findViewById(R.id.gotop);

        fwd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                circular = circular==frases.size()-1?0:circular+1;
                frase.setText(frases.get(circular));
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                circular = circular==0?frases.size()-1:circular-1;
                frase.setText(frases.get(circular));
            }
        });

        final EditText fraseN = (EditText) findViewById(R.id.fraseN);

        go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int desire = Integer.parseInt(String.valueOf(fraseN.getText()));
                if(desire>=0 && desire < frases.size()) {
                    circular = desire;
                    frase.setText(frases.get(circular));
                }
            }
